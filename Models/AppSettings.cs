...
public sealed class AppSettings
{
    ...
    public string GoogleTranslateTargetLanguage { get; set; } = "ui";
    ...
    /// <summary>Whether NewsBlur feeds and folders are mirrored automatically at application startup.</summary>
    public bool NewsBlurSyncFeedsAndFoldersAtStartup { get; set; } = true;
    /// <summary>Whether NewsBlur articles and their states are synchronized automatically at application startup.</summary>
    public bool NewsBlurSyncArticlesAndStatesAtStartup { get; set; } = true;
