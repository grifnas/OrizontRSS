...
- Direcția aprobată pentru NewsBlur este parcursă până la sincronizarea automată locală; rămân de finalizat ștergerile sincronizate, rezolvarea avansată a conflictelor și traducerile controlate ale mesajelor noi.
...
- Sincronizarea automată în fundal pentru articole și stări este implementată local și poate fi activată din Setări aplicație → Sincronizare NewsBlur, cu interval de 15, 30, 60 sau 180 de minute. Feedurile și folderele rămân la sincronizare explicită; ștergerile sincronizate și traducerile noi pentru mesajele fazelor anterioare rămân de finalizat înaintea unei distribuții. Resursele vechi verificate au fost păstrate pentru a evita regresii.
