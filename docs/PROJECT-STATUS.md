...
- Direcția aprobată pentru continuare este etapizată: Saved Stories/stelele către Favorite sau „Mai târziu”, etichete bidirecționale, redenumire și mutare completă a feedurilor și folderelor, vizualizări speciale NewsBlur, text complet la cerere, stări agregate și apoi sincronizare automată. Parolele, cheile API, notițele AI și setările vocale rămân locale.
