...
- Pregătirea pentru publicare publică este în desfășurare: sursa, tagul `v1.5.3` și Release-ul stabil sunt publicate în `grifnas/OrizontRSS`; arhiva Windows este asset oficial descărcabilă, iar activarea paginii GitHub Pages rămâne opțională.
