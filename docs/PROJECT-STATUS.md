...
- Instalatorul autonom `OrizontSetup.exe` pentru Windows x64 a fost compilat și pornește; testarea manuală a focalizării și a anunțurilor cu JAWS/NVDA rămâne necesară înainte de publicarea lui.
