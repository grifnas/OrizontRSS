...
- Publicarea publică este activă: sursa, tagul `v1.5.3`, Release-ul stabil și arhiva Windows sunt publicate în `grifnas/OrizontRSS`; pagina GitHub Pages funcționează la `https://grifnas.github.io/OrizontRSS/`.
