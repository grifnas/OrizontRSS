# Capturi de ecran pentru pagina publica

Galeria publica va folosi numai capturi reale ale aplicatiei Orizont RSS, realizate cu date demonstrative. Nu se includ fluxuri personale, adrese de email, chei API, tokenuri sau alte date private.

## Fisiere asteptate

- `main-window.png` — fereastra principala, cu lista de articole si panourile aplicatiei.
- `reader.png` — Cititorul Orizont, cu textul articolului si bara de stare.
